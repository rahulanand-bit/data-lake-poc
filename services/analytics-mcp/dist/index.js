...
function textResult(text, structuredContent) {
    const normalized = structuredContent && typeof structuredContent === "object" && !Array.isArray(structuredContent)
        ? structuredContent
        : undefined;
    return {
...
function toDirectInputFromPlan(toolInput) {
...
function toDirectToolName(tool) {
...
server.registerTool("analytics_health", {
...
server.registerTool("ask_analytics", {
    ...
    const warning = cfg.warnOnAskAnalytics
...
server.registerTool("segmentation", {
...
function parseDataset(datasetJson) {
    try {
...
function toMachinePayload(response) {
    return {
...
async function runDirectToolResponse(tool, input, role) {
