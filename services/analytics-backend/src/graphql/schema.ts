...
import type { ToolInput, ToolName } from "../types.js";
...
async function runToolIntent(toolHint: string, args: InputArg) {
  ...
  const tool = toolHint as ToolName;
...
const QueryType = new GraphQLObjectType({
  ...
  fields: {
    overview: {
      ...
      resolve: async (_, args: InputArg) => runToolIntent("overview_tool", args),
    },
    trends: {
      type: ToolResultType,
      args: {
      ...
      resolve: async (_, args: InputArg) => runToolIntent("trends_tool", args),
    },
    segmentation: {
      type: ToolResultType,
      args: {
      ...
      resolve: async (_, args: InputArg) => runToolIntent("segmentation_tool", args),
    },
    drilldown: {
      type: ToolResultType,
      args: {
      ...
      resolve: async (_, args: InputArg) => runToolIntent("drilldown_tool", args),
    },
  },
});
